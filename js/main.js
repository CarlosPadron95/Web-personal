...
const translations = {
  es: {
    ...
    about_bio_p1: "Soy Carlos, desarrollador Full-Stack de Las Palmas de Gran Canaria apasionado por construir aplicaciones modernas y completas. Mi enfoque va más allá del desarrollo tradicional: me interesa especialmente combinar el código con la automatización, creando bots, flujos automáticos y herramientas que resuelven problemas reales.",
    about_bio_p2: "He completado el Máster en Desarrollo Full-Stack en ConquerBlocks, donde profundicé en la creación de APIs REST robustas e interfaces modernas con React. Trabajo con tecnologías como Node.js, Python, Streamlit y n8n, y también desarrollo y personalizo sitios WordPress.",
    about_bio_p3: "Si tienes un proyecto en mente, hablemos.",
  ...
  en: {
    ...
    about_bio_p1: "I'm Carlos, a Full-Stack developer from Las Palmas de Gran Canaria passionate about building modern and complete applications. My focus goes beyond traditional development: I'm especially interested in combining code with automation, creating bots, automated workflows, and tools that solve real problems.",
    about_bio_p2: "I completed the Full-Stack Development Master's at ConquerBlocks, where I deepened my knowledge in creating robust REST APIs and modern interfaces with React. I work with technologies like Node.js, Python, Streamlit, and n8n, and I also develop and customize WordPress sites.",
    about_bio_p3: "If you have a project in mind, let's talk.",
