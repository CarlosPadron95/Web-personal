...
const translations = {
  es: {
    ...
    hero_desc: "Desarrollador Full-Stack orientado a producto. Disfruto creando herramientas digitales que resuelven problemas: ya sea una aplicación web compleja, una landing page impactante o un e-commerce completo.",
    ...
    about_bio_p1: "Soy Carlos, un desarrollador Full-Stack de Las Palmas de Gran Canaria apasionado por construir herramientas digitales que realmente aporten valor. Mi enfoque va más allá del desarrollo tradicional: me encanta combinar código robusto con la automatización estratégica (creando flujos con n8n, bots de WhatsApp y dashboards con Streamlit) para optimizar procesos reales.",
    about_bio_p2: "Tras graduarme del Máster en Desarrollo Web Full-Stack en ConquerBlocks, he consolidado una base técnica que me permite operar en todos los frentes. Diseño arquitecturas backend y APIs REST seguras con Python (Django / DRF), y construyo interfaces modernas y fluidas con React y Vanilla JS. Además de crear aplicaciones a medida, también desarrollo páginas web corporativas y tiendas online (e-commerce), utilizando tanto código puro como WordPress.",
    about_bio_p3: "Me define una mentalidad de aprendizaje constante: veo cada proyecto como una oportunidad para ensuciarme las manos, integrar nuevas tecnologías como Node.js y seguir creciendo.",
    about_bio_p4: "Ya sea que tu equipo busque un perfil Junior con mucho empuje y ganas de sumar, o necesites un desarrollador para dar vida a tu próxima web, tienda online o aplicación a medida, ¡hablemos!",
    ...
    proj_teamproject_desc: "Aplicación Full-Stack para gestión colaborativa con tablero Kanban (Drag & Drop), control de roles (RBAC) y chat de equipo.",
    ...
    proj_reservafacil_desc: "Aplicación Full-Stack para gestión de citas en tiempo real con proceso de reserva por pasos en React y backend en Django.",
  ...
  en: {
    ...
    hero_desc: "Product-oriented Full-Stack Developer. I enjoy building digital tools that solve problems: whether it's a complex web application, a high-impact landing page, or a complete e-commerce platform.",
    btn_projects: "View Projects",
    btn_contact: "Let's Talk",
    about_title: "About Me",
    about_subtitle: "My background, skills and specialized training.",
    about_bio_title: "Who I am",
    about_bio_p1: "I'm Carlos, a Full-Stack Developer based in Las Palmas de Gran Canaria, passionate about building digital tools that deliver real value. My approach goes beyond traditional development: I love combining robust code with strategic automation (building n8n workflows, WhatsApp bots, and Streamlit dashboards) to optimize real-world processes.",
    about_bio_p2: "After graduating from the Full-Stack Web Development Master's program at ConquerBlocks, I’ve solidified a technical foundation that allows me to operate across the entire stack. I design secure backend architectures and REST APIs using Python (Django / DRF), and build modern, fluid interfaces with React and Vanilla JS. In addition to custom web apps, I also develop corporate websites and e-commerce platforms using both custom code and WordPress.",
    about_bio_p3: "I am driven by a continuous learning mindset. I see every project as an opportunity to get my hands dirty, integrate new technologies like Node.js, and keep growing.",
    about_bio_p4: "Whether your team is looking for a driven Junior developer ready to add value, or you need a developer to bring your next website, online store, or custom application to life—let's talk!",
    ...
    proj_teamproject_desc: "Full-Stack collaborative app with Drag & Drop Kanban board, Role-Based Access Control (RBAC), and team chat.",
    ...
    proj_reservafacil_desc: "Full-Stack application for real-time appointment management featuring a multi-step booking process, built with React and a Django backend.",
